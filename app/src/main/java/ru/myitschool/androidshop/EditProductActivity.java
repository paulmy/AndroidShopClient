...
public class EditProductActivity extends Activity {
    ...
    private static final String url_product_details = "http://192.168.0.31/shop/get_product_details.php";

    // адрес для обновления базы данных
    private static final String url_update_product = "http://192.168.0.31/shop/update_product.php";

    // адрес для удаления из базы данных
    private static final String url_delete_product = "http://192.168.0.31/shop/delete_product.php";
        ...
        protected void onPreExecute() {
           ...
           /* pDialog = new ProgressDialog(EditProductActivity.this);
            ...
            Toast.makeText(getApplicationContext(),
                    "Загружается информация о товаре. Подождите...",
